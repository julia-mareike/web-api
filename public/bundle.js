    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          null,
          _react2.default.createElement('input', { name: 'newName', placeholder: 'whats yo name', onChange: this.handleChange, value: this.state.newName }),
          _react2.default.createElement('input', { name: 'newEmail', placeholder: 'whats yo email', onChange: this.handleChange, value: this.state.newEmail }),
          _react2.default.createElement(
            'button',
